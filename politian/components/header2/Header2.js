                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-md-6 col-6 d-lg-none dl-block">
                                <div className="navbar-header">
                                    <Link onClick={ClickHandler} className="navbar-brand" href="/home3"><Image src={Logo}
                                        alt="logo" /></Link>
                                </div>
                            </div>
                                    ...
                                    <ul className="nav navbar-nav mb-2 mb-lg-0">
                                        ...
                                        <li className="menu-item-has-children">
                                            ...
                                            <ul className="sub-menu">
                                                ...
                                                <li><Link href="https://shop.patrickosoicampaign.com/" onClick={ClickHandler} target="_blank" rel="noopener noreferrer">Shop</Link></li>
