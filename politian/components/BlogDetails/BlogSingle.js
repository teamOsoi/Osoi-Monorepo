                        ...
                        <div className="wpo-blog-content">
                            <div className="post format-standard-image">
                                ...
                                <div className="entry-meta">
                                    <ul>
                                        <li><i className="fi flaticon-user"></i> By <Link href="/blog-single/support-progressive-change">{BlogDetails.author}</Link> </li>
                            ...
                            <div className="tag-share-s2 clearfix">
                                <div className="tag">
                                    <span>Share: </span>
                                    <ul>
                                        <li><Link href="/blog-single/support-progressive-change">facebook</Link></li>
                                        <li><Link href="/blog-single/support-progressive-change">twitter</Link></li>
                                        <li><Link href="/blog-single/support-progressive-change">linkedin</Link></li>
                                        <li><Link href="/blog-single/support-progressive-change">pinterest</Link></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div className="author-box">
                                <div className="author-avatar">
                                    <Link href="/blog-single/support-progressive-change" target="_blank"><img src={blog6} alt="" /></Link>
                                </div>
                                <div className="author-content">
                                    <Link href="/blog-single/support-progressive-change" className="author-name">Author: Jenny Watson</Link>
                                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis.</p>
                                    <div className="socials">
                                        <ul className="social-link">
                                            <li><Link href="/blog-single/support-progressive-change"><i className="ti-facebook"></i></Link></li>
                                            <li><Link href="/blog-single/support-progressive-change"><i className="ti-twitter-alt"></i></Link></li>
                                            <li><Link href="/blog-single/support-progressive-change"><i className="ti-linkedin"></i></Link></li>
                                            <li><Link href="/blog-single/support-progressive-change"><i className="ti-instagram"></i></Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
